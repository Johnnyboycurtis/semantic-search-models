...
student_config = ModernBertConfig(
    hidden_size=384,        # Width: 768 -> 384
    num_hidden_layers=12,   # Depth: 12 Layers
    num_attention_heads=6,  # Heads: 12 -> 6 (Keeps head_dim=64)
    intermediate_size=768,  # FFN: 1152 -> 768
...
def initialize_with_guide():
    ...
    teacher = AutoModel.from_pretrained(TEACHER_ID, trust_remote_code=True, torch_dtype=torch.float32)
